...
<!-- TABLE:START -->
| # | Tool | LLMs tracked | Free option | Starts at | Best for |
| --- | --- | --- | --- | --- | --- |
| 1 | [AIclicks](https://aiclicks.io) | Claude, ChatGPT, Gemini, AI Overviews, Grok, DeepSeek, Copilot, Meta, Mistral | Free trial | $59/mo | End-to-end Claude and multi-LLM visibility tracking |
| 2 | XSeek | Claude, ChatGPT, Gemini, Perplexity, Meta AI, DeepSeek, Llama, Cohere, xAI | Not stated | $99.99/mo | Tracking paired with a content optimization studio |
| 3 | LPagery Claude AI | Claude, ChatGPT, Gemini | 7-day trial | $59/mo | Simple dashboards for small brands and beginners |
| 4 | LLMrefs | Claude, ChatGPT, Gemini, Perplexity, Copilot, DeepSeek, xAI, Meta AI | Free plan (1 keyword) | $79/mo | Cross-platform tracking with a unified visibility metric |
| 5 | Orchly.ai | Claude, ChatGPT, Gemini, AI Overviews, Perplexity, Copilot | Not stated | $49/mo | Claude tracking with backlink and ranking data |
| 6 | Rankability | Claude, ChatGPT, Perplexity, Google AIO, AI Mode, xAI, Brave, DeepSeek | Not stated | $199/mo | Citation pattern analysis with white-label reporting |
| 7 | AI Rank Lab | Claude, ChatGPT, Gemini, Perplexity | Free tier | $69/mo | Startups wanting real-time alerts |
